        const cards = [
            {
                ...
                price: 10000,
                image: "/images/4.png",
                description: "The ancient guardian of storms, master of thunder and lightning"
            },
            {
                id: 2,
                name: "Ignothar",
                ...
                description: "The incandescent titan, embodiment of rage and destruction"
            },
            {
                id: 3,
                name: "Glacior",
...
checkoutBtn.addEventListener('click', () => {
    ...
    cart.forEach(item => {
        ...
        if(existCard){
            existCard.quantity = (existCard.quantity) + (item.quantity)
        }else{
            deck.push({...item})
        }
    })
    ...
    function showDeckCards(deckCards = deck) {
        ...
        deckCards.forEach(card => {
            ...
            cardElement.innerHTML = `
                ...
                <div class="px-4 py-2 bg-[#0E0E22]">
                    <h3 class="text-2xl font-bold mb-2 text-${card.faction === "lightning" ? "purple" : card.faction === "fire" ? "orange" : "ciel"}">${card.name} <span>(${card.quantity})</span> </h3>
